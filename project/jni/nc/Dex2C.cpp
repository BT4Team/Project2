...
Java_dex2c_bt4team_Loader_initDcc__(JNIEnv *env, jobject thiz) {

}

JNIEXPORT void JNICALL
Java_dex2c_bt4team_Loader__0003cinit_0003e__(JNIEnv *env, jobject thiz) {
...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz = env->FindClass("dex2c/bt4team/Loader");
