...
def dcc_main(
    ...
    dex2c_file_data = dex2c_file_data.replace(
        'env->FindClass("dex2c/bt4team/Loader");',
        'env->FindClass("' + custom_loader.replace(".", "/") + '");',
    )
    dex2c_file_data = dex2c_file_data.replace(
        "Java_dex2c_bt4team_Loader", "Java_" + custom_loader.replace(".", "_")
    )
    ...
    if is_apk(apkfile) and outapk:
        ...
        loader_file_path = "loader/Loader.smali"
        ...
        filedata = filedata.replace(
            "Ldex2c/bt4team/Loader;", "L" + custom_loader.replace(".", "/") + ";"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--custom-loader",
        default="dex2c.bt4team.Loader",
        help="Loader class, default: dex2c.bt4team.Loader",
    )
    parser.add_argument(
        "--skip-synthetic",
        action="store_true",
